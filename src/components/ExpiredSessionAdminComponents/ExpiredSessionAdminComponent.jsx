...
import "./ExpiredSessionAdmin.css";

const ExpiredSessionAdminComponent = () => {
  ...
  const handleRedirectToLogin = () => {
    ...
    window.location.href = "/login_admin"; // Replace with your login page URL
  };

  return (
    showAlert && (
      <div className="token-expired-overlay-admin">
        <div className="token-expired-box-admin">
...
export default ExpiredSessionAdminComponent;
